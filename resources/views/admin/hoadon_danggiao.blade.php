...
@section('head')
<link rel="stylesheet" href="{{URL::asset('manager/hoadon_danggiao.css')}}"/>
@stop
...
<div id="thanhcongcu" class="d-flex align-items-center justify-content-center">
    <div class="d-inline-block ">
        <h4 class="mr-5 font-weight-bold">Đơn hàng đang giao</h4>
    </div>
    ...
    <div id="buttondiv">
        <a id="daxuly"><button type="button" class="btn btn-success">Thanh toán</button></a>
...
<script src="{{URL::asset('manager/hoadon_danggiao.js')}}"></script>
@stop
