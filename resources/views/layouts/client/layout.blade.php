		...
		<div id="header-top-wrap">
			...
			<section id="header-top" class="clearfix">
				...
				<p class="login">
					...
					<a href="register-login.html">Đăng nhập</a>, hoặc
					<a href="register-login.html">Đăng ký</a>
				</p>
			</section>
			<!-- /HEADER TOP -->
		</div>
	...
	<footer>
		...
		<div id="footer-bottom-wrap">
			<section id="footer-bottom">
				<p><a href="index.html">TheCosmo Clothing's Shop</a><br> <span>|</span> All Rights Reserved 2019</p>
				<!-- SOCIAL LINKS -->
